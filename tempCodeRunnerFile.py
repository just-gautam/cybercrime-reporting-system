...
app = Flask(__name__)
app.secret_key = "cyber_security_key"
...
def send_email_notification(receiver_email, ref_id, name):
    ...
    msg['From'] = "gautambhardwaj05851@gmail.com" 
    msg['To'] = receiver_email

    try:
        server = smtplib.SMTP('smtp.gmail.com', 587)
        server.starttls() 
        # Note: Ensure you use a Google "App Password" here, not your regular password
        server.login("gautambhardwaj05851@gmail.com", "oawm kayg mvmk jxuh") 
